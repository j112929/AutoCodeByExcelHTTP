...
public class CoderConfig implements Serializable {
	...
	private boolean isForceWriteToProject;
	...
	public boolean isForceWriteToProject() {
		return this.isForceWriteToProject;
	}

	public void setForceWriteToProject(boolean isForceWriteToProject) {
		this.isForceWriteToProject = isForceWriteToProject;
	}
}